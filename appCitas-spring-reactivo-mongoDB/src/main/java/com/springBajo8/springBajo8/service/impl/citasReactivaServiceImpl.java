...
public class citasReactivaServiceImpl implements IcitasReactivaService {
    ...
    @Override
    public Mono<medicoDTO> findByMedico(String id){
        return this.IcitasReactivaRepository.findByMedico(id);
    }

    public Mono<tratamientosDTO> findByTratamiento(String id){
        return this.IcitasReactivaRepository.findByTratamiento(id);
    }

    @Override
    public Flux<citasDTOReactiva> findByEstadoReservaCita() {

        return this.IcitasReactivaRepository.findByEstadoReservaCita();
    }
    ...
    public Flux<citasDTOReactiva> findByFechaHoraReservaCita(LocalDate fecha,String hora){
        return this.IcitasReactivaRepository.findByFechaHoraReservaCita(fecha,hora);
    }
}
